        ...
        <div class="wrapper">
            ...
            <form:form modelAttribute="requestRegistMemberVO" 
                ...
                <div class="grid member-regist">
                    ...
                    <div>
                        <input type="password" id="password" name="password"  data-pair="#password-confirm"/>
                    ...
                    <div>
                        <input type="password" id="passwordConfirm" name="passwordConfirm" data-pair="#password"/>
